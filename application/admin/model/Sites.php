...
class Sites extends Model
{
    ...
    protected static function init()
    {
        self::beforeDelete(function ($row) {
            ...
            if (isset($row['is_default'])) {
                if ($row['is_default'] == 1) {
                    throw new \think\Exception(__('Default site prohibits deletion!'));
                }
            }
        });
        self::beforeWrite(function ($row) {
            ...
            if (isset($changed['is_default'])) {
                ...
                if(isset($origin['is_default']) && $origin['is_default'] == 1 && $changed['is_default'] == 0){
                    throw new \think\Exception(__('Please set at least one default site!'));
                }
    ...
    {
        return [0 => __('Regular site'), 1 => __('Default Site')];
    }
