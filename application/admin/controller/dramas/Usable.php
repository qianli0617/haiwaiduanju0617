...
class Usable extends Backend
{
    ...
    /**
     * Usable模型对象
     * @var \app\admin\model\dramas\Usable
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\dramas\Usable;
    ...
    public function add()
    {
        ...
        if($params['usable'] != $params['original_usable'] + $params['give_usable']){
            $this->error(__('Usable')." = ".__('Original_usable')." + ".__('Give_usable'));
        }
        $result = false;
        Db::startTrans();
        try {
    ...
    public function sync(){
        $testdata_file = ADDON_PATH . "dramas" . DS . 'testdata' . DS . "usable.php";
