...
use app\admin\model\dramas\VideoPerformer;
...
class Video extends Backend
{
    ...
    protected $noNeedRight = ['changePrice', 'sync', 'sync_add', 'test_data_video', 'test_data_category', 'download', 'import', 'icon', 'episodes', 'year_category_area'];
    ...
    public function episodes($ids){
        ...
        // 小程序码
        // https://duanju.nymaite.cn/addons/dramas/wechat/wxacode?scene=id_3078&sign=xupf&path=pages/video/play
