define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'dramas/version/index' + location.search,
                    add_url: 'dramas/version/add',
                    edit_url: 'dramas/version/edit',
                    del_url: 'dramas/version/del',
                    multi_url: 'dramas/version/multi',
                    import_url: 'dramas/version/import',
                    table: 'dramas_version',
                }
            });
