define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'dramas/video_log/index' + location.search,
                    add_url: 'dramas/video_log/add',
                    edit_url: 'dramas/video_log/edit',
                    del_url: 'dramas/video_log/del',
                    multi_url: 'dramas/video_log/multi',
                    import_url: 'dramas/video_log/import',
                    table: 'dramas_video_log',
                }
            });
