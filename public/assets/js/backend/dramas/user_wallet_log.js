define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'dramas/user_wallet_log/index' + location.search,
                    add_url: 'dramas/user_wallet_log/add',
                    edit_url: 'dramas/user_wallet_log/edit',
                    del_url: 'dramas/user_wallet_log/del',
                    multi_url: 'dramas/user_wallet_log/multi',
                    import_url: 'dramas/user_wallet_log/import',
                    table: 'dramas_user_wallet_log',
                }
            });
