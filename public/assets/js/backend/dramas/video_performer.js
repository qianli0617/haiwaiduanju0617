define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'dramas/video_performer/index' + location.search,
                    add_url: 'dramas/video_performer/add',
                    edit_url: 'dramas/video_performer/edit',
                    del_url: 'dramas/video_performer/del',
                    multi_url: 'dramas/video_performer/multi',
                    import_url: 'dramas/video_performer/import',
                    table: 'dramas_video_performer',
                }
            });
