    ...
    var Controller = {
            ...
            var indexPage = new Vue({
                ...
                methods: {
                    ...
                    operation(type, id) {
                        ...
                        switch (type) {
                            case 'create':
                                Fast.api.open('dramas/cryptocard/add', __('Add'), {
                                    callback() {
                                        that.getData();
                                    }
                                })
                            ...
                            case 'del':
                                ...
                                if (ids) {
                                    that.$confirm(__('Are you sure you want to delete this item?'), __('Warning'), {
                                        ...
                                        Fast.api.ajax({
                                            url: 'dramas/cryptocard/del/ids/' + ids,
                                            loading: true,
                                            type: 'POST'
                                        }, function (ret, res) {
                                            that.getData();
                                ...
                                break;
                            case 'recyclebin':
                                Fast.api.open('dramas/cryptocard/recyclebin', __('Recycle bin'), {
                                    callback() {
                                        that.getData();
                                    }
                                })
                    ...
                    goExport() {
                        ...
                        window.location.href = Config.moduleurl + "/dramas/cryptocard/export" + "?filter=" + JSON.stringify(filter) + "&op=" + JSON.stringify(op);
                    },
                    //筛选
                    changeSwitch() {
                    ...
                    reqScreenList() {
                        ...
                        Fast.api.ajax({
                            url: 'dramas/cryptocard/selectSearch?type='+that.searchForm.type,
                            loading: true,
                            type: "GET",
                        }, function (ret, res) {
        ...
        recyclebin: function () {
            ...
            table.bootstrapTable({
                url: 'dramas/cryptocard/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [{
                ...
                data() {
                    return {
                        ...
                        rules: {
                            ...
                            type: [{
                                required: true,
                                message: __('Please enter the type'),
                                trigger: 'blur'
                            }],
                            usetime: [{
                                required: true,
                                message: __('Please select the usetime'),
                                trigger: 'change'
                            }],
                            item_id: [{
                                required: true,
                                message: __('Please select the item_id'),
                                trigger: 'change'
                            }],
                            stock: [{
                                required: true,
                                message: __('Please enter the stock'),
                                trigger: 'blur'
                            }],
                            pwd_type: [{
                                required: true,
                                message: __('Please enter the pwd_type'),
                                trigger: 'blur'
                            }],
                            pwd_len: [{
                                required: true,
                                message: __('Please enter the pwd_len'),
                                trigger: 'blur'
                            }],
                        },
                        options: []
