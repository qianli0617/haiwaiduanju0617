define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'dramas/vip_order/index' + location.search,
                    add_url: 'dramas/vip_order/add',
                    edit_url: 'dramas/vip_order/edit',
                    del_url: 'dramas/vip_order/del',
                    multi_url: 'dramas/vip_order/multi',
                    import_url: 'dramas/vip_order/import',
                    table: 'dramas_vip_order',
                }
            });
                ...
                columns: [
                    [
                        ...
                        {field: 'vip_id', title: __('Vip_id'),
                            visible: false,
                            addclass: 'selectpage',
                            extend: 'data-source="dramas/vip/index" data-field="title"',
                            operate: '=',
