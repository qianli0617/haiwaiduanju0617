define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'dramas/usable_order/index' + location.search,
                    add_url: 'dramas/usable_order/add',
                    edit_url: 'dramas/usable_order/edit',
                    del_url: 'dramas/usable_order/del',
                    multi_url: 'dramas/usable_order/multi',
                    import_url: 'dramas/usable_order/import',
                    table: 'dramas_usable_order',
                }
            });
                ...
                columns: [
                    [
                        ...
                        {field: 'usable_id', title: __('Usable_id'),
                            visible: false,
                            addclass: 'selectpage',
                            extend: 'data-source="dramas/usable/index" data-field="title"',
                            operate: '=',
                        ...
                        {field: 'usables.title', title: __('Usables.title'), operate: 'LIKE'},
