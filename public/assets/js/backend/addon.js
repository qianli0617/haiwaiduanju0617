    ...
    var Controller = {
        index: function () {
            ...
            $(document).on("click", ".btn-authorization", function () {
                ...
                Layer.confirm(__('Are you sure you want to refresh authorization?'), {icon: 3, title: __('Warmtips'), btn: [__('Ok'), __('Cancel')]}, function () {
                    Fast.api.ajax({
            ...
            $(document).on("click", ".btn-uninstall", function () {
                ...
                Layer.confirm(Template("uninstalltpl", {addon: Config['addons'][name]}), {focusBtn: false, title: __("Warning"), btn: [__('Ok'), __('Cancel')]}, function (index, layero) {
            ...
            $(document).on("click", ".btn-upgrade", function () {
                ...
                Layer.confirm(__('Upgrade tips', Config['addons'][name].title), {btn: [__('Ok'), __('Cancel')]}, function (index, layero) {
        ...
        api: {
            formatter: {
                ...
                version: function (value, row, index) {
                    if(row.name == 'dramas'){
                        return row.addon && row.addon.version != row.version ? '<a href="https://doc.weixin.qq.com/doc/w3_ADsAuwZlAB8Rp1SeYyERRqXZ8ahp0?scode=AEIAIgdXAAoS916jF8" target="_blank"><span class="releasetips text-primary" data-toggle="tooltip" title="' + __('New version tips', row.version) + '">' + row.addon.version + '<i></i></span></a>' : row.version;
                    }else{
