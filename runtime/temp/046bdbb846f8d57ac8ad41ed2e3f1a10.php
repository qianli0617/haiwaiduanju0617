...
<div id="categoryDetail" v-cloak>
    <el-form :model="detailForm" :rules="rulesForm" ref="detailForm" label-width="108px" class="detail-form">
        <el-form-item :label="__('Lang id')" prop="lang">
            <el-radio-group v-model="detailForm.lang_id" v-for="key, val in lang_list">
                <el-radio :label="val" style="height: 20px;line-height: 20px;margin: 5px;">{{__(key)}}</el-radio>
            </el-radio-group>
        </el-form-item>
        <el-form-item :label="__('Type')" prop="type">
            <el-radio-group v-model="detailForm.type" v-for="key, val in type_list">
                <el-radio :label="val" style="height: 20px;line-height: 20px;margin: 5px;">{{key}}</el-radio>
            </el-radio-group>
        </el-form-item>
        <el-form-item :label="__('Name')" prop="name">
            <el-input type="input" v-model="detailForm.name" size="small"></el-input>
        </el-form-item>
        <el-form-item :label="__('Weigh')" prop="weigh">
            <el-input type="number" v-model="detailForm.weigh" size="small"></el-input>
        </el-form-item>
    ...
    <div class="dialog-footer display-flex">
        <div @click="deletecategory" class="dialog-cancel-btn display-flex-c cursor-pointer">{{__('Delete')}}</div>
