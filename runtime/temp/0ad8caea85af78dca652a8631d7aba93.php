<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:82:"/www/wwwroot/duanju.doukang.shop/public/../application/admin/view/index/index.html";i:1715757698;s:72:"/www/wwwroot/duanju.doukang.shop/application/admin/view/common/meta.html";i:1715757698;s:74:"/www/wwwroot/duanju.doukang.shop/application/admin/view/common/header.html";i:1715757698;s:72:"/www/wwwroot/duanju.doukang.shop/application/admin/view/common/menu.html";i:1715757698;s:75:"/www/wwwroot/duanju.doukang.shop/application/admin/view/common/control.html";i:1715757698;s:74:"/www/wwwroot/duanju.doukang.shop/application/admin/view/common/script.html";i:1715757698;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- 加载样式及META信息 -->
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="hidden-xs">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-language" style="margin-right: 5px;"></i><?php echo __('Choose language'); ?></a>
                    <ul class="dropdown-menu">
                        <?php if(is_array(\think\Config::get('allow_lang_list')) || \think\Config::get('allow_lang_list') instanceof \think\Collection || \think\Config::get('allow_lang_list') instanceof \think\Paginator): if( count(\think\Config::get('allow_lang_list'))==0 ) : echo "" ;else: foreach(\think\Config::get('allow_lang_list') as $key=>$tab): ?>
                        <li class="<?php echo $config['language']==$tab?'active':''; ?>">
                            <a href="?ref=addtabs&lang=<?php echo $tab; ?>"><?php echo __($tab); ?></a>
                        </li>
